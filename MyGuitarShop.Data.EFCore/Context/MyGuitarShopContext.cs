...
public partial class MyGuitarShopContext : DbContext
{
    ...
    public virtual DbSet<VwCustomerAddress> VwCustomerAddresses { get; set; }

    
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.HasDefaultSchema("migrations_owner");

        modelBuilder.Entity<Address>(entity =>
        {
            entity.HasKey(e => e.AddressId).HasName("PK__Addresse__091C2A1BAE542486");
        ...
        {
            entity.HasKey(e => e.AdminId).HasName("PK__Administ__719FE4E808B66B50");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Categori__19093A2B576F0373");

            entity.ToTable("Categories", "dbo");

            entity.HasIndex(e => e.CategoryName, "UQ__Categori__8517B2E07DB085C9").IsUnique();
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__A4AE64B84605519F");

            entity.ToTable("Customers", "dbo");

            entity.HasIndex(e => e.EmailAddress, "UQ__Customer__49A14740B9DC797A").IsUnique();
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__C3905BAFBE0ADB27");
        ...
        {
            entity.HasKey(e => e.ItemId).HasName("PK__OrderIte__727E83EB5E83710B");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6ED4C9CCA3D");

            entity.ToTable("Products", "dbo", tb => tb.HasTrigger("Products_INSERT"));

            entity.HasIndex(e => e.ProductCode, "UQ__Products__2F4E024F62BD1BE2").IsUnique();
        ...
        modelBuilder.Entity<VwCustomerAddress>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_CustomerAddresses", "dbo");

            entity.Property(e => e.BillCity)
                .HasMaxLength(40)
                .IsUnicode(false);
            entity.Property(e => e.BillLine1)
                .HasMaxLength(60)
                .IsUnicode(false);
            entity.Property(e => e.BillLine2)
                .HasMaxLength(60)
                .IsUnicode(false);
            ...
            entity.Property(e => e.ShipCity)
                .HasMaxLength(40)
                .IsUnicode(false);
            entity.Property(e => e.ShipLine1)
                .HasMaxLength(60)
                .IsUnicode(false);
            entity.Property(e => e.ShipLine2)
                .HasMaxLength(60)
                .IsUnicode(false);
